...
- Route mention validation for Next.js App Router, Next.js Pages Router, FastAPI app/router decorators, Flask decorators, Django URL patterns, and literal Express route calls.
