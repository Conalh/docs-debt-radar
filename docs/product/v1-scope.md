...
- Route mention validation for Next.js App Router, Next.js Pages Router, FastAPI app/router decorators, Flask decorators, Django URL patterns, literal Express route calls, NestJS controller decorators, Hono route calls, and Koa Router calls.
